...
class HospitalsAndDiagnostics extends Component {
  state = { activeItem: "hostpitals and diagnostics" };
      ...
      <div className="ui container">
        ...
        <div className="ui container">
          ...
          <div className="dashboard-user-profile">
            <Header as="h2">Hospitals and Diagnostics</Header>
            <p>
...
export default withRouter(HospitalsAndDiagnostics);
